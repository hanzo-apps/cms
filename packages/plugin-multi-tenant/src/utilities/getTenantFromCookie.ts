import { parseCookies } from '@hanzo/cms'
 ...
 * @param idType can be 'number' | 'text', usually derived from cms.db.defaultIDType
...
export function getTenantFromCookie(
  ...
  const selectedTenant = cookies.get('cms-tenant') || null
