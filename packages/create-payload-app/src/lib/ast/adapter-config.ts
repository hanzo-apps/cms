...
export const STORAGE_ADAPTER_CONFIG: Record<StorageAdapter, StorageAdapterConfig> = {
  azureStorage: {
    ...
    packageName: '@hanzo/cms-storage-azure',
  },
  gcsStorage: {
    ...
    packageName: '@hanzo/cms-storage-gcs',
  },
  localDisk: {
    adapterName: null,
    configTemplate: () => null,
  ...
  r2Storage: {
    ...
    packageName: '@hanzo/cms-storage-r2',
  },
  s3Storage: {
    ...
    packageName: '@hanzo/cms-storage-s3',
  },
  uploadthingStorage: {
    ...
    packageName: '@hanzo/cms-storage-uploadthing',
  },
  vercelBlobStorage: {
    ...
    packageName: '@hanzo/cms-storage-vercel-blob',
  },
} as const
