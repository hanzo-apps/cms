...
import { traverseFields } from '@hanzo/cms'
import { fieldAffectsData } from '@hanzo/cms/shared'

/**
 * Recursively traverses a CMS field schema to collect all field paths
 ...
 *
 * @param fields - The top-level array of CMS field definitions
