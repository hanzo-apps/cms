...
export const myTranslations: DefaultTranslationsObject = {
  ...
  folder: {
    ...
    folderTypeDescription:
      'ဤဖိုလ်ဒါတွင် ခွင့်ပြုသင့်သော စုစည်းမှု စာရွက်စာတမ်းအမျိုးအစားများကို ရွေးချယ်ပါ။',
    itemHasBeenMoved: '{{title}} ကို {{folderName}} သို့ ရွှေ့လိုက်ပါပြီ',
    ...
    itemsMovedToRoot: '{{title}} ကို ဗဟိုဖိုလ်ဒါသို့ ရွှေ့လိုက်ပါပြီ',
    moveFolder: 'ဖိုလ်ဒါ ရွှေ့ပါ',
    moveItemsToFolderConfirmation:
      'သင့်တွင် <1>{{count}} {{label}}</1> <2>{{toFolder}}</2>သို့ ရွှေ့နေသည့်အခါဖြစ်ပါသည်။ သေချာပါသလား?',
    moveItemsToRootConfirmation:
      'သင်သည် <1>{{count}} {{label}}</1> ကို ဗဟိုဖိုလ်ဒါသို့ ရွှေ့ပါတော့မည်။ သေချာပါသလား။',
    moveItemToFolderConfirmation:
      'သင်သည် <1>{{title}}</1> ကို <2>{{toFolder}}</2> သို့ ရွှေ့ပါတော့မည်။ သေချာပါသလား။',
    moveItemToRootConfirmation:
      'သင်သည် <1>{{title}}</1> ကို ဗဟိုဖိုလ်ဒါသို့ ရွှေ့ပါတော့မည်။ သေချာပါသလား။',
    movingFromFolder: '{{fromFolder}} မှ {{title}} ကို ရွှေ့နေသည်',
    newFolder: 'ဖိုလ်ဒါ အသစ်',
    noFolder: 'ဖိုလ်ဒါမရှိပါ',
    renameFolder: 'ဖိုလ်ဒါအမည်ပြောင်းရန်',
    searchByNameInFolder: 'နာမည်ဖြင့် {{folderName}} တွင် ရှာဖွေပါ',
    selectFolderForItem: '{{title}} အတွက် ဖိုလ်ဒါ ရွေးချယ်ပါ',
  },
  general: {
    name: 'နာမည်',
    aboutToDelete:
