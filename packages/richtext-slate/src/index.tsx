...
export function slateEditor(
  ...
  return async ({ config }) => {
    ...
    return {
      CellComponent: '@hanzo/cms-richtext-slate/rsc#RscEntrySlateCell',
      FieldComponent: {
        path: '@hanzo/cms-richtext-slate/rsc#RscEntrySlateField',
        serverProps: {
          args,
        },
      },
      generateImportMap: ({ addToImportMap }) => {
        addToImportMap('@hanzo/cms-richtext-slate/rsc#RscEntrySlateCell')
        addToImportMap('@hanzo/cms-richtext-slate/rsc#RscEntrySlateField')
